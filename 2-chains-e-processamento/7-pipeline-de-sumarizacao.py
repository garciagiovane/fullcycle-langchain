...
# vai fazer um resumo de cada parte do texto, e depois um resumo dos resumos, ou seja, um resumo do resumo
...
splitter = RecursiveCharacterTextSplitter(chunk_size=200, chunk_overlap=70)
...
map_prompt = PromptTemplate.from_template("write concise summary of the following text: {context}")
...
reduce_prompt = PromptTemplate.from_template("combine the following summaries into a single concise summary: {context}")
